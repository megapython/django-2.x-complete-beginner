...
def profile(request, username):
    ...
    # Published Questions
    p_questions = Question.objects.filter(author=user, status="published")
    d_questions = Question.objects.filter(author=user, status="draft")  # new
    p_answers = Answer.objects.filter(author=user, status="published") # new
    d_answers = Answer.objects.filter(author=user, status="draft")  # new
